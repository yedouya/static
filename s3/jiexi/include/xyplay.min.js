    ...
    xyplayer.prototype = {
        ...
        init: function (c)
        {
            ...
            if (this.play.off.autoline === "1") {
                ...
                } else if (this.play.off.ckplay === "0") {
                    this.onflag = 'line';
                }
            ...
            switch (this.type)
            {
                ...
                case 'url':
                    ...
                    if (!this.headplay('url',this.url)) {
                        if (this.play.off.link === '1' && this.type === "url") {
                            this.Getvideobyurl();
        ...
        success: function (code,data,get) {
            ...
            switch (code)
            {
                ...
                case 3:
                    ...
                    //重新加载线路列表
                    this.reline();
                    var url = (this.playlist_array.length > 0) ? (this.playlist_array[this.part]) : data.url;
        ...
        AutoPlay: function (type,url,play)
        {
            ...
            switch (type)
            {
                ...
                case 'list':
                    ...
                    if (this.headplay('url',url) || this.headplay('type',play) || this.headplay('flag',url)) {
                        return;
                    } else {
        ...
        jxplay: function (num,word,nosave) {
            ...
            if (this.url_array.length > 0)
            {
                ...
                var url = this.url_array[this.myurl] + word;
                //使用play.html加载
        ...
        errorHandler: function (word)
        {
            ...
            if (reload !== window.location.href) {
                ...
                if ("undefined" !== this.url_array && this.url_array.length > 0) {
